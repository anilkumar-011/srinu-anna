'use client'
import { appleWatches } from "@/app/products";

const AppleWatchSellingPage = () => {
            ...
            <section className="py-12 bg-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl md:text-2xl text-gray-700 mb-10 animate-fade-in-up delay-200">
                        Explore the full range of Apple Watch models and personalize your style.
                    </p>
                </div>
            </section>
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="text-gray-600 text-sm mb-1">
                                        <span className="font-medium">Year Introduced:</span> {watch.year_introduced}
                                    </p>
                                    <p className="text-gray-600 text-sm mb-1">
                                        <span className="font-medium">Case Materials:</span> {watch.case_materials.join(', ')}
                                    </p>
                                    <p className="text-gray-600 text-sm mb-3">
                                        <span className="font-medium">Connectivity:</span> {watch.connectivity.join(', ')}
                                    </p>
...
export default AppleWatchSellingPage;